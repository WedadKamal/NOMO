...
import com.NOMO.angularAutomation.strategy.testData.TestDataStrategy;
import com.NOMO.angularAutomation.backendServices.ServicesDelegate;
import com.NOMO.angularAutomation.pages.HomePage;
import com.NOMO.angularAutomation.pages.LoginPage;
import com.NOMO.angularAutomation.pages.NomoHomePage;
import com.NOMO.angularAutomation.pages.STCHomePage;
import com.NOMO.angularAutomation.utils.Log;
import com.NOMO.angularAutomation.utils.PropertiesFilesHandler;
import com.NOMO.angularAutomation.utils.ServerLog;
...
public class BaseTest {
	...
	public void loadConfiguration(String url,String browserType)
	{
		try {
			...
			NomoHomePage = new NomoHomePage(driver);
		}
		catch(Exception e)
		{
